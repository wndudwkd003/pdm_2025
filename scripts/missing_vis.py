...
if __name__ == "__main__":
    ...
    start_dir = Path(
        "outputs/2025-11-17_08-57-50_mymodel_mptms_none_0.0"
    )
    end_dir = Path(
        "outputs/2025-11-17_14-57-04_mymodel_mptms_mcar_0.8"
    )

    run_prefix = "mymodel_mptms"

    # 요약 그래프 저장 위치
    save_dir = start_dir.parent / "summary_plots_mymodel_multimodal_setting_mptms_range"
